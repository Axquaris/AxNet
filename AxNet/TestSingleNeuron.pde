...
void setupUi() {
  inputA = new UiSlider(10, 10, 280, 30, 0, 1, 1);
  //inputB = new UiSlider(10, 50, 280, 30, 0, 1, 1);
  
  weightA = new UiSlider(310, 10, 280, 30, -5, 5, 1);
  weightA.button = color(100);
  weightB = new UiSlider(310, 50, 280, 30, -5, 5, 1);
